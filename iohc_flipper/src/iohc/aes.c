...
// Minimal AES-128 ECB encrypt implementation (FIPS-197).
// Public-domain table-driven implementation. ~200 bytes RAM + ~2KB flash.
...
static void shift_rows(uint8_t s[16]) {
    ...
    t = s[2]; uint8_t u = s[6]; s[2] = s[10]; s[6] = s[14]; s[10] = t; s[14] = u;
